...
export default function FullscreenButton({ 
  ...
  const handleClick = () => {
    if (!isSupported) {
      alert('Fullscreen is not supported in this browser context. On iOS, add to Home Screen to get fullscreen, or install the PWA.')
      return
    }
  ...
  return (
    <button
      ...
      title={!isSupported ? 'Fullscreen unsupported in this context' : (isFullscreen ? 'Exit fullscreen' : 'Enter fullscreen')}
    >
      {isFullscreen ? (
