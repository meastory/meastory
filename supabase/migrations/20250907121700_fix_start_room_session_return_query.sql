-- Ensure start_room_session emits one row using RETURN QUERY
...
BEGIN
  ...
  INTO v_session_id, v_ret_started_at, v_ret_tier;
  ...
  RETURN QUERY SELECT v_session_id, v_room_id, v_ret_tier, v_ret_started_at, v_duration_ms;
END $$;
